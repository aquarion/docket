	...
	updateDateTime: () => {
		...
		if (datetimeEl) {
			datetimeEl.innerHTML =
				...
				strToday +
				"</div>";
			var callback = FestivalUtils?.getCallback?.("afterRenderDateTime");
